...
//    [self.window makeKeyAndVisible];
    ...
    NSUInteger DbVersion = [settingsDao getDbVersion];
    
    if (DbVersion == 0)
    {
        [dbUtils createPixTables];
        [settingsDao updateDbVersion:1];
    }
    else if (iosDbVersion > DbVersion)
    {
        [dbUtils updatePixTables];
        [settingsDao updateDbVersion:iosDbVersion];
    }
