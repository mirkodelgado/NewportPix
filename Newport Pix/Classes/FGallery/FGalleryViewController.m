...
//    _container.backgroundColor			= [UIColor blackColor];
	...
	UIImage *leftIcon = [UIImage imageNamed:@"LeftArrow"];
	UIImage *rightIcon = [UIImage imageNamed:@"RightArrow"];
...
{
    int barHeight = 0;
//    if (self.navigationController.navigationBar.barStyle == UIBarStyleBlackTranslucent) {     //mgd+091814
